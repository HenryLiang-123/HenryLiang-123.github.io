...
citation: 'Henry Liang, Yu Zhou, and Vijay K. Gurbani. 2024. Efficient and verifiable responses using Retrieval Augmented Generation (RAG). In Proceedings of the 4th International Conference on AI-ML Systems (AIMLSystems 24). Association for Computing Machinery, New York, NY, USA, Article 19, 1-6.'
---
